		...
		unsigned long rate)
{
	...
	PLL_REG_W(dp_res->ln_tx0_base,
			REG_DP_PHY_TXn_INTERFACE_SELECT, 0x3b);
	PLL_REG_W(dp_res->ln_tx0_base,
			REG_DP_PHY_TXn_CLKBUF_ENABLE, 0x0f);
	PLL_REG_W(dp_res->ln_tx0_base,
			REG_DP_PHY_TXn_RESET_TSYNC_EN, 0x03);
	PLL_REG_W(dp_res->ln_tx0_base,
			REG_DP_PHY_TXn_TRAN_DRVR_EMP_EN, dp_res->txn_tran_drv_emp_en);
	PLL_REG_W(dp_res->ln_tx0_base,
...
static int dp_pll_enable_10nm(struct clk_hw *hw)
{
	...
	PLL_REG_W(dp_res->ln_tx0_base, REG_DP_PHY_TXn_TX_DRV_LVL, 0x3f);
	PLL_REG_W(dp_res->ln_tx1_base, REG_DP_PHY_TXn_TX_DRV_LVL, 0x3f);
	PLL_REG_W(dp_res->ln_tx0_base, REG_DP_PHY_TXn_TX_EMP_POST1_LVL, 0x23);
	PLL_REG_W(dp_res->ln_tx1_base, REG_DP_PHY_TXn_TX_EMP_POST1_LVL, 0x23);
	PLL_REG_W(dp_res->ln_tx0_base, REG_DP_PHY_TXn_RES_CODE_LANE_OFFSET_TX, 0x11);
	PLL_REG_W(dp_res->ln_tx1_base, REG_DP_PHY_TXn_RES_CODE_LANE_OFFSET_TX, 0x11);
	PLL_REG_W(dp_res->ln_tx0_base, REG_DP_PHY_TXn_RES_CODE_LANE_OFFSET_RX, 0x11);
	PLL_REG_W(dp_res->ln_tx1_base, REG_DP_PHY_TXn_RES_CODE_LANE_OFFSET_RX, 0x11);
	PLL_REG_W(dp_res->ln_tx0_base, REG_DP_PHY_TXn_INTERFACE_SELECT, 0x3b);
	PLL_REG_W(dp_res->ln_tx1_base, REG_DP_PHY_TXn_INTERFACE_SELECT, 0x3b);
