...
#define REG_DP_PHY_AUX_CFG2			0x0028
...
#define REG_DP_PHY_VCO_DIV			0x0070
#define REG_DP_PHY_TX0_TX1_LANE_CTL		0x0078
#define REG_DP_PHY_TX2_TX3_LANE_CTL		0x009C

#define REG_DP_PHY_SPARE0			(0x00C8)
#define DP_PHY_SPARE0_MASK			(0x000F)
#define DP_PHY_SPARE0_ORIENTATION_INFO_SHIFT	(0x0004)

#define REG_DP_PHY_STATUS			(0x00DC)
...
#define REG_DP_PHY_TXn_TX_DRV_LVL				0x0014
#define DP_PHY_TXn_TX_DRV_LVL_MUX_EN		0x0020

#define REG_DP_PHY_TXn_RESET_TSYNC_EN			0x001C
#define REG_DP_PHY_TXn_PRE_STALL_LDO_BOOST_EN		0x0020
#define REG_DP_PHY_TXn_TX_BAND				0x0024
#define REG_DP_PHY_TXn_INTERFACE_SELECT			0x002C

#define REG_DP_PHY_TXn_RES_CODE_LANE_OFFSET_TX		0x003C
#define REG_DP_PHY_TXn_RES_CODE_LANE_OFFSET_RX		0x0040

#define REG_DP_PHY_TXn_TRANSCEIVER_BIAS_EN			0x0054
#define REG_DP_PHY_TXn_HIGHZ_DRVR_EN			0x0058
#define REG_DP_PHY_TXn_TX_POL_INV				0x005C
#define REG_DP_PHY_TXn_PARRATE_REC_DETECT_IDLE_EN		0x0060

#define REG_DP_PHY_TXn_TRAN_DRVR_EMP_EN			0x00B8
#define REG_DP_PHY_TXn_TX_INTERFACE_MODE			0x00BC

#define REG_DP_PHY_TXn_VMODE_CTRL1				0x00E8
