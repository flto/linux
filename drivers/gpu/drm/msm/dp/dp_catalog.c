			       ...
			       u32 offset)
{
	 ...
	 * this function uses writel() instread of writel_relaxed()
	 */
	return readl_relaxed(catalog->io->dp_p0.base + offset);
}
...
void dp_catalog_dump_regs(struct dp_catalog *dp_catalog)
{
	...
	for (i = 0; i < len; i++) {
		x0 = dp_read_ahb(catalog, addr_off + 0x0);
		x4 = dp_read_ahb(catalog, addr_off + 0x4);
		x8 = dp_read_ahb(catalog, addr_off + 0x8);
		xc = dp_read_ahb(catalog, addr_off + 0xc);
	...
	for (i = 0; i < len; i++) {
		x0 = dp_read_aux(catalog, addr_off + 0x0);
		x4 = dp_read_aux(catalog, addr_off + 0x4);
		x8 = dp_read_aux(catalog, addr_off + 0x8);
		xc = dp_read_aux(catalog, addr_off + 0xc);
		pr_info("%08x : %08x %08x %08x %08x\n", addr_off, x0, x4, x8,
			xc);
	...
	for (i = 0; i < len; i++) {
		x0 = dp_read_link(catalog, addr_off + 0x0);
		x4 = dp_read_link(catalog, addr_off + 0x4);
		x8 = dp_read_link(catalog, addr_off + 0x8);
		xc = dp_read_link(catalog, addr_off + 0xc);
		pr_info("%08x : %08x %08x %08x %08x\n", addr_off, x0, x4, x8,
			xc);
	...
	for (i = 0; i < len; i++) {
		x0 = dp_read_p0(catalog, addr_off + 0x0);
		x4 = dp_read_p0(catalog, addr_off + 0x4);
		x8 = dp_read_p0(catalog, addr_off + 0x8);
		xc = dp_read_p0(catalog, addr_off + 0xc);
		pr_info("%08x : %08x %08x %08x %08x\n", addr_off, x0, x4, x8,
			xc);
	...
	len = catalog->io->usb3_dp_com.len;
	addr_off = 0;
	...
	for (i = 0; i < len; i++) {
		x0 = dp_read_usb_cm(catalog, addr_off + 0x0);
		x4 = dp_read_usb_cm(catalog, addr_off + 0x4);
		x8 = dp_read_usb_cm(catalog, addr_off + 0x8);
		xc = dp_read_usb_cm(catalog, addr_off + 0xc);
		pr_info("%08x : %08x %08x %08x %08x\n", addr_off, x0, x4, x8,
			xc);
	...
	for (i = 0; i < len; i++) {
		x0 = dp_read_ln_tx0(catalog, addr_off + 0x0);
		x4 = dp_read_ln_tx0(catalog, addr_off + 0x4);
		x8 = dp_read_ln_tx0(catalog, addr_off + 0x8);
		xc = dp_read_ln_tx0(catalog, addr_off + 0xc);
		pr_info("%08x : %08x %08x %08x %08x\n", addr_off, x0, x4, x8,
			xc);
	...
	for (i = 0; i < len; i++) {
		x0 = dp_read_ln_tx1(catalog, addr_off + 0x0);
		x4 = dp_read_ln_tx1(catalog, addr_off + 0x4);
		x8 = dp_read_ln_tx1(catalog, addr_off + 0x8);
		xc = dp_read_ln_tx1(catalog, addr_off + 0xc);
		pr_info("%08x : %08x %08x %08x %08x\n", addr_off, x0, x4, x8,
			xc);
	...
	for (i = 0; i < len; i++) {
		x0 = dp_read_phy(catalog, addr_off + 0x0);
		x4 = dp_read_phy(catalog, addr_off + 0x4);
		x8 = dp_read_phy(catalog, addr_off + 0x8);
		xc = dp_read_phy(catalog, addr_off + 0xc);
		pr_info("%08x : %08x %08x %08x %08x\n", addr_off, x0, x4, x8,
			xc);
					...
					u32 pattern)
{
	...
	ret = readx_poll_timeout(readl, catalog->io->dp_link.base +
