...
static void dsi_pll_calc_dec_frac(struct dsi_pll_7nm *pll)
{
	...
	regs->pll_clock_inverters = 0x0; // TODO v2 0x28
...
static void dsi_pll_config_hzindep_reg(struct dsi_pll_7nm *pll)
{
	...
	pll_write(base + REG_DSI_7nm_PHY_PLL_GEAR_BAND_SELECT_CONTROLS, 0x21); // TODO v2 0x22
	...
	pll_write(base + REG_DSI_7nm_PHY_PLL_IFILT, 0x30); // TODO v2 0x22
}
