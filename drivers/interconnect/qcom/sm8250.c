...
DEFINE_QNODE(qnm_mnoc_hf_display, SM8250_MASTER_MNOC_HF_MEM_NOC_DISPLAY, 2, 32, SM8250_SLAVE_LLCC_DISPLAY);
DEFINE_QNODE(qnm_mnoc_sf_display, SM8250_MASTER_MNOC_SF_MEM_NOC_DISPLAY, 2, 32, SM8250_SLAVE_LLCC_DISPLAY);
DEFINE_QNODE(llcc_mc_display, SM8250_MASTER_LLCC_DISPLAY, 4, 4, SM8250_SLAVE_EBI_CH0_DISPLAY);
DEFINE_QNODE(qxm_mdp0_display, SM8250_MASTER_MDP_PORT0_DISPLAY, 1, 32, SM8250_SLAVE_MNOC_HF_MEM_NOC_DISPLAY);
DEFINE_QNODE(qxm_mdp1_display, SM8250_MASTER_MDP_PORT1_DISPLAY, 1, 32, SM8250_SLAVE_MNOC_HF_MEM_NOC_DISPLAY);
DEFINE_QNODE(qxm_rot_display, SM8250_MASTER_ROTATOR_DISPLAY, 1, 32, SM8250_SLAVE_MNOC_SF_MEM_NOC_DISPLAY);
...
DEFINE_QNODE(qns_llcc_display, SM8250_SLAVE_LLCC_DISPLAY, 4, 16, SM8250_MASTER_LLCC_DISPLAY);
DEFINE_QNODE(ebi_display, SM8250_SLAVE_EBI_CH0_DISPLAY, 4, 4, );
DEFINE_QNODE(qns_mem_noc_hf_display, SM8250_SLAVE_MNOC_HF_MEM_NOC_DISPLAY, 2, 32, SM8250_MASTER_MNOC_HF_MEM_NOC_DISPLAY);
DEFINE_QNODE(qns_mem_noc_sf_display, SM8250_SLAVE_MNOC_SF_MEM_NOC_DISPLAY, 2, 32, SM8250_MASTER_MNOC_SF_MEM_NOC_DISPLAY);
...
DEFINE_QBCM(bcm_acv_display, "ACV", false, &ebi_display);
/* DEFINE_QBCM(bcm_alc_display, "ALC", false, ); */
DEFINE_QBCM(bcm_mc0_display, "MC0", false, &ebi_display);
DEFINE_QBCM(bcm_sh0_display, "SH0", false, &qns_llcc_display);
DEFINE_QBCM(bcm_mm0_display, "MM0", false, &qns_mem_noc_hf_display);
DEFINE_QBCM(bcm_mm1_display, "MM1", false, &qxm_mdp0_display, &qxm_mdp1_display);
DEFINE_QBCM(bcm_mm2_display, "MM2", false, &qns_mem_noc_sf_display);
...
static struct qcom_icc_desc sm8250_gem_noc_display = {
...
static struct qcom_icc_desc sm8250_mc_virt_display = {
...
static struct qcom_icc_node *mmss_noc_display_nodes[] = {
	...
	[SLAVE_MNOC_SF_MEM_NOC_DISPLAY] = &qns_mem_noc_sf_display,
};

static struct qcom_icc_desc sm8250_mmss_noc_display = {
