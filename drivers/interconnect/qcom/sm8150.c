...
DEFINE_QNODE(qnm_mnoc_hf_display, SM8150_MASTER_MNOC_HF_MEM_NOC_DISPLAY, 2, 32, SM8150_SLAVE_LLCC_DISPLAY);
DEFINE_QNODE(qnm_mnoc_sf_display, SM8150_MASTER_MNOC_SF_MEM_NOC_DISPLAY, 1, 32, SM8150_SLAVE_LLCC_DISPLAY);
DEFINE_QNODE(llcc_mc_display, SM8150_MASTER_LLCC_DISPLAY, 4, 4, SM8150_SLAVE_EBI_CH0_DISPLAY);
DEFINE_QNODE(qxm_mdp0_display, SM8150_MASTER_MDP_PORT0_DISPLAY, 1, 32, SM8150_SLAVE_MNOC_HF_MEM_NOC_DISPLAY);
DEFINE_QNODE(qxm_mdp1_display, SM8150_MASTER_MDP_PORT1_DISPLAY, 1, 32, SM8150_SLAVE_MNOC_HF_MEM_NOC_DISPLAY);
DEFINE_QNODE(qxm_rot_display, SM8150_MASTER_ROTATOR_DISPLAY, 1, 32, SM8150_SLAVE_MNOC_SF_MEM_NOC_DISPLAY);
...
DEFINE_QNODE(qns_llcc_display, SM8150_SLAVE_LLCC_DISPLAY, 4, 16, SM8150_MASTER_LLCC_DISPLAY);
DEFINE_QNODE(ebi_display, SM8150_SLAVE_EBI_CH0_DISPLAY, 4, 4, );
DEFINE_QNODE(qns2_mem_noc_display, SM8150_SLAVE_MNOC_SF_MEM_NOC_DISPLAY, 1, 32, SM8150_MASTER_MNOC_SF_MEM_NOC_DISPLAY);
DEFINE_QNODE(qns_mem_noc_hf_display, SM8150_SLAVE_MNOC_HF_MEM_NOC_DISPLAY, 2, 32, SM8150_MASTER_MNOC_HF_MEM_NOC_DISPLAY);
...
DEFINE_QBCM(bcm_mm2_display, "MM2", false, &qns2_mem_noc_display);
DEFINE_QBCM(bcm_mm3_display, "MM3", false, &qxm_rot_display);
...
static const struct of_device_id qnoc_of_match[] = {
	...
	{ .compatible = "qcom,sm8150-gem-noc-display",
	  .data = &sm8150_gem_noc_display},
	{ .compatible = "qcom,sm8150-mc-virt-display",
	  .data = &sm8150_mc_virt_display},
	{ .compatible = "qcom,sm8150-mmss-noc-display",
	  .data = &sm8150_mmss_noc_display},
	{ }
};
