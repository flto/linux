...
static const struct qmp_phy_init_tbl sdm845_qmp_pcie_serdes_tbl[] = {
#if 0
	QMP_PHY_INIT_CFG(0x094, 0x08),
	QMP_PHY_INIT_CFG(0x154, 0x34),
	QMP_PHY_INIT_CFG(0x16c, 0x08),
	QMP_PHY_INIT_CFG(0x058, 0x0f),
	QMP_PHY_INIT_CFG(0x0a4, 0x42),
	QMP_PHY_INIT_CFG(0x110, 0x24),
	QMP_PHY_INIT_CFG(0x11c, 0x03),
	QMP_PHY_INIT_CFG(0x118, 0xb4),
	QMP_PHY_INIT_CFG(0x10c, 0x02),
	QMP_PHY_INIT_CFG(0x1bc, 0x11),
	QMP_PHY_INIT_CFG(0x0bc, 0x82),
	QMP_PHY_INIT_CFG(0x0d4, 0x03),
	QMP_PHY_INIT_CFG(0x0d0, 0x55),
	QMP_PHY_INIT_CFG(0x0cc, 0x55),
	QMP_PHY_INIT_CFG(0x0b0, 0x1a),
	QMP_PHY_INIT_CFG(0x0ac, 0x0a),
	QMP_PHY_INIT_CFG(0x0c4, 0x68),
	QMP_PHY_INIT_CFG(0x0e0, 0x02),
	QMP_PHY_INIT_CFG(0x0dc, 0xaa),
	QMP_PHY_INIT_CFG(0x0d8, 0xab),
	QMP_PHY_INIT_CFG(0x0b8, 0x34),
	QMP_PHY_INIT_CFG(0x0b4, 0x14),
	QMP_PHY_INIT_CFG(0x158, 0x01),
	QMP_PHY_INIT_CFG(0x074, 0x06),
	QMP_PHY_INIT_CFG(0x07c, 0x16),
	QMP_PHY_INIT_CFG(0x084, 0x36),
	QMP_PHY_INIT_CFG(0x078, 0x06),
	QMP_PHY_INIT_CFG(0x080, 0x16),
	QMP_PHY_INIT_CFG(0x088, 0x36),
	QMP_PHY_INIT_CFG(0x1b0, 0x1e),
	QMP_PHY_INIT_CFG(0x1ac, 0xca),
	QMP_PHY_INIT_CFG(0x1b8, 0x18),
	QMP_PHY_INIT_CFG(0x1b4, 0xa2),
	QMP_PHY_INIT_CFG(0x050, 0x07),
	QMP_PHY_INIT_CFG(0x010, 0x01),
	QMP_PHY_INIT_CFG(0x01c, 0x31),
	QMP_PHY_INIT_CFG(0x020, 0x01),
	QMP_PHY_INIT_CFG(0x024, 0xde),
	QMP_PHY_INIT_CFG(0x028, 0x07),
	QMP_PHY_INIT_CFG(0x030, 0x4c),
	QMP_PHY_INIT_CFG(0x034, 0x06),
	QMP_PHY_INIT_CFG(0x048, 0x90),
#else
	QMP_PHY_INIT_CFG(0x094, 0x08),
	QMP_PHY_INIT_CFG(0x154, 0x34),
	QMP_PHY_INIT_CFG(0x16c, 0x08),
	...
	QMP_PHY_INIT_CFG(0x030, 0x4c),
	QMP_PHY_INIT_CFG(0x034, 0x06),
	QMP_PHY_INIT_CFG(0x29c, 0x12),
	QMP_PHY_INIT_CFG(0x284, 0x35),
	QMP_PHY_INIT_CFG(0x23c, 0x11),
	QMP_PHY_INIT_CFG(0x51c, 0x03),
	QMP_PHY_INIT_CFG(0x518, 0x1c),
	QMP_PHY_INIT_CFG(0x524, 0x1e),
	QMP_PHY_INIT_CFG(0x4e8, 0x00),
	QMP_PHY_INIT_CFG(0x4ec, 0x0e),
	QMP_PHY_INIT_CFG(0x4f0, 0x4a),
	QMP_PHY_INIT_CFG(0x4f4, 0x0f),
	QMP_PHY_INIT_CFG(0x5b4, 0x04),
	QMP_PHY_INIT_CFG(0x434, 0x7f),
	QMP_PHY_INIT_CFG(0x444, 0x70),
	QMP_PHY_INIT_CFG(0x510, 0x17),
	QMP_PHY_INIT_CFG(0x4d4, 0x04),
	QMP_PHY_INIT_CFG(0x4d8, 0x07),
	QMP_PHY_INIT_CFG(0x598, 0xd4),
	QMP_PHY_INIT_CFG(0x59c, 0x54),
	QMP_PHY_INIT_CFG(0x5a0, 0xdb),
	QMP_PHY_INIT_CFG(0x5a4, 0x3b),
	QMP_PHY_INIT_CFG(0x5a8, 0x31),
	QMP_PHY_INIT_CFG(0x584, 0x24),
	QMP_PHY_INIT_CFG(0x588, 0xe4),
	QMP_PHY_INIT_CFG(0x58c, 0xec),
	QMP_PHY_INIT_CFG(0x590, 0x3b),
	QMP_PHY_INIT_CFG(0x594, 0x36),
	QMP_PHY_INIT_CFG(0x570, 0x3f),
	QMP_PHY_INIT_CFG(0x574, 0x3f),
	QMP_PHY_INIT_CFG(0x578, 0xff),
	QMP_PHY_INIT_CFG(0x57c, 0x7f),
	QMP_PHY_INIT_CFG(0x580, 0x14),
	QMP_PHY_INIT_CFG(0x4fc, 0x00),
	QMP_PHY_INIT_CFG(0x4f8, 0xc0),
	QMP_PHY_INIT_CFG(0x460, 0x30),
	QMP_PHY_INIT_CFG(0x464, 0x00),
	QMP_PHY_INIT_CFG(0x5bc, 0x0c),
	QMP_PHY_INIT_CFG(0x4dc, 0x1b),
	QMP_PHY_INIT_CFG(0x408, 0x0c),
	QMP_PHY_INIT_CFG(0x414, 0x03),
	QMP_PHY_INIT_CFG(0x5b8, 0x30),
	QMP_PHY_INIT_CFG(0x9a4, 0x01),
	QMP_PHY_INIT_CFG(0xc90, 0x00),
	QMP_PHY_INIT_CFG(0xc40, 0x01),
	QMP_PHY_INIT_CFG(0xc48, 0x01),
	QMP_PHY_INIT_CFG(0xc50, 0x00),
	QMP_PHY_INIT_CFG(0xcb4, 0x33),
	QMP_PHY_INIT_CFG(0xcbc, 0x00),
	QMP_PHY_INIT_CFG(0xce0, 0x58),
	QMP_PHY_INIT_CFG(0xca4, 0x0f),
	QMP_PHY_INIT_CFG(0x048, 0x90),
	QMP_PHY_INIT_CFG(0xc1c, 0xc1),
	QMP_PHY_INIT_CFG(0x988, 0x77),
	QMP_PHY_INIT_CFG(0x998, 0x0b),
	QMP_PHY_INIT_CFG(0x8dc, 0x0d),
	QMP_PHY_INIT_CFG(0x9ec, 0x12),
#endif
};
