...
#define CPU_BASE_IRIS2				0xa0000

#define CPU_CS_A2HSOFTINTCLR			(CPU_CS_BASE + 0x1c)
#define CPU_CS_A2HSOFTINTCLR_IRIS2		(CPU_BASE_IRIS2 + 0x1c)

#define VIDC_CTRL_INIT				(CPU_CS_BASE + 0x48)
#define VIDC_CTRL_INIT_IRIS2			(CPU_BASE_IRIS2 + 0x48)
...
#define CPU_CS_SCIACMDARG0_IRIS2		(CPU_BASE_IRIS2 + 0x4c)
...
#define CPU_CS_SCIACMDARG1_IRIS2		(CPU_BASE_IRIS2 + 0x50)

/* HFI queue table address */
#define CPU_CS_SCIACMDARG2			(CPU_CS_BASE + 0x54)
#define CPU_CS_SCIACMDARG2_IRIS2		(CPU_BASE_IRIS2 + 0x54)

/* Venus cpu */
#define CPU_CS_SCIACMDARG3			(CPU_CS_BASE + 0x58)
#define CPU_CS_SCIACMDARG3_IRIS2		(CPU_BASE_IRIS2 + 0x58)
...
#define SFR_ADDR_IRIS2				(CPU_BASE_IRIS2 + 0x5c)
#define MMAP_ADDR_IRIS2				(CPU_BASE_IRIS2 + 0x60)
#define UC_REGION_ADDR_IRIS2			(CPU_BASE_IRIS2 + 0x64)
#define UC_REGION_SIZE_IRIS2			(CPU_BASE_IRIS2 + 0x68)

#define CPU_CS_H2XSOFTINTEN_IRIS2		(CPU_BASE_IRIS2 + 0x148)

#define CPU_IC_SOFTINT				(CPU_IC_BASE + 0x18)
#define CPU_IC_SOFTINT_H2A_MASK			0x8000
#define CPU_IC_SOFTINT_H2A_SHIFT		0xf

#define CPU_IC_SOFTINT_IRIS2			(CPU_BASE_IRIS2 + 0x150)
#define CPU_IC_SOFTINT_H2A_SHIFT_IRIS2		0x0

#define CPU_CS_X2RPMh_IRIS2			(CPU_BASE_IRIS2 + 0x168)
...
#define WRAPPER_BASE_IRIS2			0x000b0000
#define WRAPPER_TZ_BASE				0x000c0000

#define WRAPPER_INTR_STATUS_IRIS2		(WRAPPER_BASE_IRIS2 + 0x0c)
#define WRAPPER_INTR_STATUS_A2HWD_MASK_IRIS2	0x8
#define WRAPPER_INTR_STATUS_A2H_MASK_IRIS2	0x4

#define WRAPPER_INTR_MASK_IRIS2			(WRAPPER_BASE_IRIS2 + 0x10)
#define WRAPPER_INTR_MASK_A2HWD_MASK_IRIS2	0x8
#define WRAPPER_INTR_MASK_A2HCPU_MASK_IRIS2	0x4

#define WRAPPER_CPU_CLOCK_CONFIG_IRIS2		(WRAPPER_BASE_IRIS2 + 0x10000)
#define WRAPPER_CPU_STATUS_IRIS2		(WRAPPER_BASE_IRIS2 + 0x10010)
